...
export default async function NewDocumentPage() {
  const [customers, jobs, issuers, quotations] = await Promise.all([
    getCustomers(), getJobs(), getIssuers(), getQuotations(),
  ])
  ...
  return (
    <div className="space-y-6">
      ...
      <DocumentForm customers={customers} jobs={jobs} issuers={issuers} quotations={quotations} />
    </div>
  )
}
