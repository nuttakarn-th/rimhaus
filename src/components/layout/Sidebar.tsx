...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-60 bg-white border-r border-[hsl(35,20%,88%)] flex flex-col z-30">
      {/* Logo */}
      <div className="h-16 flex items-center px-6 border-b border-[hsl(35,20%,88%)]">
